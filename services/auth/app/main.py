...
# Create FastAPI app
app = FastAPI(
    title="Grimoire Auth Service",
    description="Authentication and User Management microservice for Grimoire OS",
    version="0.1.0",
...
async def startup_event():
    ...
    grpc_thread = threading.Thread(
        target=lambda: setattr(globals(), "grpc_server", serve_grpc(port=50051)),
        daemon=True,
    )
    grpc_thread.start()
